   ...
   #calculating the slope of the lines
    ...
    for c in contours:
        ...
        for i in range(len(closest_edges) - 1):
            ...
            cv2.line(img, line_start_point, (closest_edges[i][0]+2000, closest_edges[i][1]), (255, 0, 255), 1) 
...
checkChartType("C:/Users/Lakshan/OneDrive/Documents/GitHub/Chart-Reader/Images/Vertical_Bar_chart/VBC59.jpg")
#axisLines("C:/Users/Lakshan/OneDrive/Documents/GitHub/Chart-Reader/New folder(2)/result.png", 1)
#pieChart("C:/Users/Lakshan/OneDrive/Documents/GitHub/Chart-Reader/Readingdatafile/39.png")
