...
pyautogui.write('w1867568@my.westminster.ac.uk')
...
while (True):
    ...
    for element in elements:
        ...
        time.sleep(1)
        png_button = driver.find_elements(By.XPATH, "//div[@class='statisticDownload__item']/button[contains(., 'PNG')]")
        print(len(png_button))
        if len(png_button) > 0:
            print(png_button[0].text)
            print(png_button[0].get_attribute('class'))
        png_button.click()
        time.sleep(4)    
